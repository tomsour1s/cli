...
import { a as Gt, d as Vt, f as Wt, l as Qt, n as logger } from "./logger-DgyoxKia.mjs";
...
import { i as FastURL, n as serve, t as NodeResponse } from "./node-D_YiNK7m.mjs";
import { n as clearDir } from "./fs-DDhFmxBK.mjs";
...
var analyze_default = defineCommand({
	...
	async run(ctx) {
		...
		Wt(colors.cyan("Analyzing bundle size..."));
